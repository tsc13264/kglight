...
class SOTLAgent(BaseAgent):
    ...
    def __init__(self, world, rank):
        ...
        self.phase_lane_map_in = Registry.mapping['world_mapping']['setting'].param['phase_lane_map_in']
        self.phase_time = Registry.mapping['trainer_mapping']['setting'].param['action_interval']
        self.last_set_time = 0
        self.last_action = 0
        self.phase_num = len(self.inter.phases)
    ...
    #         num_green_vehicles = sum([lane_waiting_count[lane] for lane in self.inter.phase_available_startlanes[self.inter.current_phase]])
    ...
    def get_action(self, ob, phase, test=True):
        ...
        lane_waiting_count = self.world.eng.get_lane_waiting_vehicle_count()
        ...
        if self.world.eng.get_current_time() - self.last_set_time >= self.phase_time:
            self.last_set_time = self.world.eng.get_current_time()
