...
class ECOLightAgent(RLAgent):
    def __init__(self, world, rank):
        ...
        phase_2_passable_lane_idx = Registry.mapping['world_mapping']['setting'].param['phase_2_passable_lane_idx'][self.inter_obj.num_in_lanes]
        self.phase_2_passable_lane = torch.tensor(phase_2_passable_lane_idx, device=self.device)
