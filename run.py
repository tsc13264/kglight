...
parser.add_argument('--delay_type', type=str, default="real", choices=['apx','real'], help="method of calculating delay") # apx(approximate) or real
...
parser.add_argument('-w', '--world', type=str, default="cbengine", choices=['cityflow', 'cbengine'], help="simulator type")
parser.add_argument('-n', '--network', type=str, default="cb_hangzhou44", help="network name")
